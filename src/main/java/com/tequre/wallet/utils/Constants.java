...
//	 public static final String TOKEN_PASSWORD= "APimTDu!2019@";
...
//	 public static final String basicAuthorizationToken = "cEQzTTlRU3RnWnRpNnFfZ3hBbEx3NnRaWWFJYTpLWmgyc0M5WFA3TTU0VHNrekJ1T3VMNklUUjhh";
	...
	public static final String TOKEN_USER="uppclgenx";
	public static final String TOKEN_PASSWORD="APimUPrdU!2019@";
    ...
    public static String LEVEL_2_APPROVER_ID = "approver_Level2_Id";

    public static String VOUCHER_PREFIX = "UPPCL-";

    public static String UPPCL_ACC = "UPCA";

    public static String UPPCL_VAN = "UPPCL";
    ...
    public static long ENT_TIME_FACTOR = 24 * 60 * 60 * 1000;
}
