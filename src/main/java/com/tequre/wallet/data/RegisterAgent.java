...
@Document(collection = "agent_requests")
public class RegisterAgent extends BaseEntity {
    ...
    @Enumerated(EnumType.STRING)
    private RegisterAgentStatus status;
    ...
    public RegisterAgentStatus getStatus() {
        return status;
    }

    public void setStatus(RegisterAgentStatus status) {
        this.status = status;
    }
