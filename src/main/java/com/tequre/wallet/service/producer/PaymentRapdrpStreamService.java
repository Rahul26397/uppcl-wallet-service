...
import com.tequre.wallet.consumer.payment.PaymentRapdrpStream;
...
@Service
public class PaymentRapdrpStreamService {

    private final Logger logger = LoggerFactory.getLogger(PaymentRapdrpStreamService.class);

    @Autowired
    private PaymentRapdrpStream paymentStream;
